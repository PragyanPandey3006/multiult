...
class GetUserStarGiftRequest(TLRequest):
    CONSTRUCTOR_ID = 0xb502e4a5
    SUBCLASS_OF_ID = 0x104df2c

    def __init__(self, msg_id: List[int]):
        """
...
class SaveStarGiftRequest(TLRequest):
    CONSTRUCTOR_ID = 0x92fd2aae
    SUBCLASS_OF_ID = 0xf5b399ac

    def __init__(self, msg_id: int, unsave: Optional[bool]=None):
        """
        :returns Bool: This type has no constructors.
        """
        self.msg_id = msg_id
    ...
    def from_reader(cls, reader):
        ...
        _msg_id = reader.read_int()
        return cls(msg_id=_msg_id, unsave=_unsave)
...
class TransferStarGiftRequest(TLRequest):
    CONSTRUCTOR_ID = 0x333fb526
    SUBCLASS_OF_ID = 0x8af52aac

    def __init__(self, msg_id: int, to_id: 'TypeInputUser'):
        """
        :returns Updates: Instance of either UpdatesTooLong, UpdateShortMessage, UpdateShortChatMessage, UpdateShort, UpdatesCombined, Updates, UpdateShortSentMessage.
        """
        self.msg_id = msg_id
    ...
    async def resolve(self, client, utils):
        self.to_id = utils.get_input_user(await client.get_input_entity(self.to_id))
    ...
    def from_reader(cls, reader):
        ...
        return cls(msg_id=_msg_id, to_id=_to_id)


class UpgradeStarGiftRequest(TLRequest):
    CONSTRUCTOR_ID = 0xcf4f0781
    SUBCLASS_OF_ID = 0x8af52aac

    def __init__(self, msg_id: int, keep_original_details: Optional[bool]=None):
        """
        :returns Updates: Instance of either UpdatesTooLong, UpdateShortMessage, UpdateShortChatMessage, UpdateShort, UpdatesCombined, Updates, UpdateShortSentMessage.
        """
        self.msg_id = msg_id
    ...
    def from_reader(cls, reader):
        ...
        _msg_id = reader.read_int()
        return cls(msg_id=_msg_id, keep_original_details=_keep_original_details)
